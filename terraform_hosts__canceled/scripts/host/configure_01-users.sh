...
#sudo echo "" >> /etc/sudoers/$NEW_USER_LOGIN                                                       ## -bash: /etc/sudoers: Permission denied
#sudo echo "## CUSTOM_RECORDS" >> /etc/sudoers.d/$NEW_USER_LOGIN                                    ## -bash: /etc/sudoers: Permission denied
#sudo echo "$NEW_USER_LOGIN    ALL=(ALL:ALL)    NOPASSWD: ALL" >> /etc/sudoers.d/$NEW_USER_LOGIN    ## -bash: /etc/sudoers: Permission denied
...
#sudo cat /tmp/.ssh/id_ed25519.pub >> /home/$NEW_USER_LOGIN/.ssh/authorized_keys                    ## -bash: /home/devops/.ssh/authorized_keys: Permission denied
